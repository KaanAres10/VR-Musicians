...
public class CountryWeapon : MonoBehaviour
{
...
// Also update material color (URP/HDRP often uses this instead)
        ...
        // --- Shooting: trigger once = one shot ---
        bool triggerPressed = triggerAction.action.WasPerformedThisFrame(); // edge press

        if (triggerPressed)
        {
            // optional: still keep fireRate if you want to prevent super-fast spam
